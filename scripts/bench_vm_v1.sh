...
tmp=$(mktemp)
test | tee $tmp
(echo "Benchmark time: $DATE" && cat $tmp) > /root/nhanhoa-scripts/result/result_$1_$DATE2.log

# Remote sync to fio-1
# rsync -arv  /root/nhanhoa-scripts/result root@fio-com1:/root/nhanhoa-scripts/result
